 ...
 * These 6 core parameters create distinctly different sounds.
 * The optional `effects` array adds a processing chain (reverb, delay, etc.)
 * that is applied to every sound generated by this instrument.
 */
export interface InstrumentConfig {
  ...
  pitchMult: number;
  /** Optional effects chain applied to all sounds from this instrument */
