...
const UNIFORMS = {
  colors: [[0.12,0.07,0.09],[0.65,0.28,0.22],[0.88,0.65,0.55],[0.98,0.93,0.88],[0.98,0.93,0.88],[0.98,0.93,0.88],[0.98,0.93,0.88],[0.98,0.93,0.88]] as [number, number, number][],
  colorCount: 4,
  scale: 1.080,
  intensity: 0.500,
  paramA: 0.500,
