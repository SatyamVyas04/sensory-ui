---
title: "Configuration"
description: "Configure sensory-ui with sensory.config.js — sound packs, volume, categories, and overrides."
---


sensory-ui is configured through the `config` object passed to `<SensoryUIProvider>`. Many projects keep these values in a user-owned `sensory.config.js` at the project root and spread it into the provider — that file is a convention, never overwritten by updates.
...
<Cards>
  <Card icon={<IconFeather className="size-4 text-rose-400" />} title="soft" description="Warm, gentle sine tones." />
  <Card icon={<IconWind className="size-4 text-sky-400" />} title="aero" description="Balanced modern SaaS. Default." />
  <Card icon={<IconBolt className="size-4 text-amber-400" />} title="arcade" description="8-bit chiptune punch." />
  <Card icon={<IconLeaf className="size-4 text-green-400" />} title="organic" description="Natural wooden warmth." />
  <Card icon={<IconDroplet className="size-4 text-cyan-400" />} title="glass" description="Crystalline shimmer." />
  <Card icon={<IconSettings className="size-4 text-zinc-400" />} title="industrial" description="Metallic grit." />
  <Card icon={<IconCircle className="size-4 text-stone-400" />} title="minimal" description="Pure restrained tones." />
  <Card icon={<IconMoon className="size-4 text-violet-400" />} title="retro" description="Vintage analog synth." />
  <Card icon={<IconSparkles className="size-4 text-emerald-400" />} title="crisp" description="Sharp hi-fi precision." />
</Cards>
