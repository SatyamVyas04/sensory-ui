---
title: "Sound Packs"
description: "9 sound packs with instrument-based architecture, effects system, and custom pack creation."
---
...
<Cards>
  <Card title="soft" description="Warm, rounded, gentle — felt mallets on soft pads." />
  <Card title="aero" description="Airy, breathy, ethereal — wind through chimes. Default." />
  <Card title="arcade" description="8-bit chiptune — square waves, punchy." />
  <Card title="organic" description="Natural, warm, wooden — marimba, wood blocks." />
  <Card title="glass" description="Crystalline, bright — struck glass or bells." />
  <Card title="industrial" description="Metallic, harsh, mechanical — machines and metal." />
  <Card title="minimal" description="Clean, sparse, understated — pure tones only." />
  <Card title="retro" description="Analog synth — vintage synthesizers." />
  <Card title="crisp" description="Sharp, defined, precise — high-quality headphones." />
</Cards>
...
interface InstrumentConfig {
  ...
  gainMult: number;   // Volume multiplier (0.4–1.0)
...
| industrial | 3000 | 12 | sawtooth | 0.6 | 1.0 | 0.7 | distortion |
