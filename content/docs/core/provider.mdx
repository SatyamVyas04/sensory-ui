---
title: "Provider"
description: "React provider architecture, context shape, reduced motion hook, and AudioContext lifecycle management."
---
...
All of these require a client boundary. Every sensory-ui module carries its own `"use client"` directive — the provider, the `usePlaySound` hook, and each of the 24 component files — so any file that imports `useSensoryUI` is a client component.
